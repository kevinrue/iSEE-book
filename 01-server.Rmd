...
Following the hierarchy of panel types, each call to the signature caches the information in the `se` object itself, before calling `callNextMethod()` to invoke the parent signature.
