...
This function takes the `se` object and the optioanl `colormap` argument provided to `iSEE()`, and carries out a number of compatibility checks between the two objects.
