...
We set up an example using our favorite dataset, creating a `SingleCellExperiment` object with some precomputed dimensionality reduction results.
...
Brushing at any location in the `RedDimPlot` will trigger dynamically recompution of results in our `DynRedDimPlot`.
