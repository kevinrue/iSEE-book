...
Refer to \texttt{help("Panel-class")} for more information about the
slots and methods provided by this class.
...
\texttt{help("DotPlot-class")} for more information.
...
GUI. Refer to \texttt{help("Table-class")} for more information.
...
\texttt{help(".generateDotPlot")} for more information.
...
\texttt{se} object and the optioanl \texttt{colormap} argument provided
...
section of \texttt{help(".generateDotPlot")} for more information.
