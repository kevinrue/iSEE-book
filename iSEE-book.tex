...
\chapter{Add a constructor function}\label{add-a-constructor-function}}
...
\chapter{Set the panel name in the GUI}\label{set-the-panel-name-in-the-gui}}
...
\chapter{Define the commands generating a plot output}\label{define-the-commands-generating-a-plot-output}}
