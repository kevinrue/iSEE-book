...
In the chapter \protect\hyperlink{panels}{Panel classes}, we saw how each type of panel is defined as an S4 class, organised in a hierarchy that allows new panel classes to inherit sets of properties from parent classes.
...
To do so, we declare our new class with a new unique name, \emph{e.g.} \texttt{RedDimHexbinPlot}, that contains the builtin panel class \texttt{RedDimPlot}.
