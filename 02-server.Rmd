...
Each individual panel (e.g., _RedDimPlot_) and family of panels (e.g., _ColDotPlot_) defines a `.refineParameters` function.
...
This function coerces the `se` to `SingleCellExperiment`, flatten nested DataFrames, add row and column names, and remove other non-atomic fields.
