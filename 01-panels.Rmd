...
- `Panel` <i class="fa fa-eye-slash"></i>
    - `DotPlot` <i class="fa fa-eye-slash"></i>
        - `ColumnDotPlot` <i class="fa fa-eye-slash"></i>
            - `ReducedDimensionPlot`
            - `ColumnDataPlot`
            - `FeatureAssayPlot`
        - `RowDotPlot` <i class="fa fa-eye-slash"></i>
            - `RowDataPlot`
            - `SampleAssayPlot`
    - `Table` <i class="fa fa-eye-slash"></i>
        - `RowTable` <i class="fa fa-eye-slash"></i>
            - `RowDataTable`
        - `ColumnTable` <i class="fa fa-eye-slash"></i>
            - `ColDataTable`
    - `ComplexHeatmapPlot`

Some of those classes are "virtual" (indicated by <i class="fa fa-eye-slash"></i>), meaning that they cannot be directly instanciated as panels in the GUI.
...
Refer to `help("DotPlot-class")` for more information.
...
Refer to `help("Table-class")` for more information.
